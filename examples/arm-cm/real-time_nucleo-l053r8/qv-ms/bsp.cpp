...
void SysTick_Handler(void) {
    ...
    if ((tmp & (1U << B1_PIN)) != 0U) { // debounced B1 state changed?
        if ((current & (1U << B1_PIN)) != 0U) { // is B1 depressed?
            ...
            static APP::SporadicSpecEvt const sporadicA {
                APP::SPORADIC_A_SIG, 189U, 23U
            };
            // immutable forward-press event
            static APP::SporadicSpecEvt const sporadicB {
                APP::SPORADIC_B_SIG, 89U, 23U
            };
...
QP::QEvt const *getEvtPeriodic1(uint8_t num) {
    ...
    static APP::PeriodicSpecEvt const periodicSpec1[] = {
        { APP::PERIODIC_SPEC_SIG, 40U, 5U },
        { APP::PERIODIC_SPEC_SIG, 30U, 7U }
    };
...
QP::QEvt const *getEvtPeriodic4(uint8_t num) {
    ...
    static APP::PeriodicSpecEvt const periodicSpec4[] = {
        { APP::PERIODIC_SPEC_SIG, 20U, 2U },
        { APP::PERIODIC_SPEC_SIG, 10U, 1U }
    };
